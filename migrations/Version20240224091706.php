 ...
 */
final class Version20240224091706 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE avis ADD spot_id INT NOT NULL,DROP spot, CHANGE id id INT AUTO_INCREMENT NOT NULL, CHANGE Contenu contenu LONGTEXT NOT NULL');
